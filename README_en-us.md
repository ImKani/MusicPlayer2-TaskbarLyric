...
> This is the source repository for the personal `MusicPlayer2-TaskbarLyric` fork. It keeps the taskbar lyric IPC changes and is intended to make upstream synchronization and source availability clear.
>
